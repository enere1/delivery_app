...
class _ProductRepository implements ProductRepository {
  ...
  Future<PaginationModel<ProductItem>> paginate(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PaginationModel<ProductItem>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PaginationModel<ProductItem>.fromJson(
      _result.data!,
      (json) => ProductItem.fromJson(json as Map<String, dynamic>),
    );
    return value;
  }
