...
class _OrderRepository implements OrderRepository {
  ...
  @override
  Future<void> postOrder({required PostOrderBody body}) async {
  ...
  Future<PaginationModel<OrderModel>> paginate(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PaginationModel<OrderModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PaginationModel<OrderModel>.fromJson(
      _result.data!,
